...
const Cart = () => {
	...
	const onClearCart = () => {
		if (window.confirm('Вы действительно хотит очистить корзину?')) {
			dispatch(clearCart());
		}
	};
	...
	const onMinusItem = React.useCallback((id) => {
						...
						<div className='content__items'>
							{addedPizzas.map((obj) => (
								<CartItem
									key={obj.id}
									{...obj}
									pizzaTotalPrice={items[obj.id].totalPrice}
									pizzaTotalCount={items[obj.id].items.length}
